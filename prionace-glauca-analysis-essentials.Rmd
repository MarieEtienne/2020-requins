...
par(mfrow = c(1, 5))
for (sigma in c(0.1, 0.5)) {
	for (b in c(1, 5)) {
		detfc_line <- detfc_equation(dist * 10,
																 sigma = sigma,
																 b  = b)
		plot(x = dist, y = detfc_line, type = "l", main = paste("sigma =", sigma, "et b =", b))
	}
}
```
...
# 
# plot(x = dist, y = proba_detec3, type = "l", main = "Fonction de détection avec seaState = 3")
# grid()
# 
# plot(x = dist, y = proba_detec2, type = "l", main = "Fonction de détection avec seaState = 2")
# grid()
# 
# plot(x = dist, y = proba_detec1, type = "l", main = "Fonction de détection avec seaState = 1")
# grid()
# 
# plot(x = dist, y = proba_detec0, type = "l", main = "Fonction de détection sans covariables")
# grid()
```
