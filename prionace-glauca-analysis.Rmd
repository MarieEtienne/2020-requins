...
res_abondance <- data.frame(
	...
	"Min" = c(
		sum(dsm_s2_av1.pred$fit - (2 * dsm_s2_av1.pred$se.fit)),
		sum(dsm_s3_av1.pred$fit - (2 * dsm_s3_av1.pred$se.fit)),
		sum(dsm_s2_av041.pred$fit - (2 * dsm_s2_av1.pred$se.fit)),
		sum(dsm_s3_av041.pred$fit - (2 * dsm_s3_av1.pred$se.fit)),
		sum(dsm_s2_avshelf.pred$fit - (2 * dsm_s2_av1.pred$se.fit)),
		sum(dsm_s3_avshelf.pred$fit - (2 * dsm_s3_av1.pred$se.fit))
	),
	"Estimation" = c(
